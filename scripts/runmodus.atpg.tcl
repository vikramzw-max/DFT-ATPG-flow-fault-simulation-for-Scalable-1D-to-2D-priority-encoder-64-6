...
#-------------------------------------------------------------------------------
# --- ADD THIS BLOCK TO FIND THE 90nm LIBRARY MODELS ---
puts ">>> Actively Locating 90nm Library Models..."
set LIBRARY ""
catch {
...
build_model \
    -cell     pe64_top \
    -techlib  $LIBRARY \
    -designsource $WORKDIR/pe64_top.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/pe64_top.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 pe64_top_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_pe64_top_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 pe64_top_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_pe64_top_atpg
...
check_log log_commit_tests_FULLSCAN_pe64_top_atpg

#-------------------------------------------------------------------------------
# LAUNCH GUI FOR VISUALIZATION
#-------------------------------------------------------------------------------
puts ">>> ATPG Run Complete! Launching Modus GUI..."
gui_show
#exit
